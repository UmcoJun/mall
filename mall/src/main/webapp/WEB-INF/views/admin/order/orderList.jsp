...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<div class="row">
		<div class="col-md-2">주문상태</div>
		<div class="col-md-7">
			<button type="button" class="btn btn-primary" style="width: 110px;" name="btnOderStatus" data-odr_status="전체">전체</button>
			<button type="button" class="btn btn-primary" style="width: 110px;" name="btnOderStatus" data-odr_status="주문접수">주문접수(${orderStatus1})</button>
			<button type="button" class="btn btn-primary" style="width: 110px;" name="btnOderStatus" data-odr_status="결제완료">결제완료(${orderStatus2})</button>
			<button type="button" class="btn btn-primary" style="width: 110px;" name="btnOderStatus" data-odr_status="배송준비중">배송준비중(${orderStatus3})</button>
			<button type="button" class="btn btn-primary" style="width: 110px;" name="btnOderStatus" data-odr_status="배송처리">배송처리(${orderStatus4})</button>
			<button type="button" class="btn btn-primary" style="width: 110px;" name="btnOderStatus" data-odr_status="배송완료">배송완료(${orderStatus5})</button>
			<button type="button" class="btn btn-primary" style="width: 110px;" name="btnOderStatus" data-odr_status="주문취소">주문취소(${orderStatus6})</button>
			<button type="button" class="btn btn-primary" style="width: 110px;" name="btnOderStatus" data-odr_status="미주문">미주문(${orderStatus7})</button>
	    	<button type="button" class="btn btn-primary" style="width: 110px;" name="btnOderStatus" data-odr_status="취소요청">취소요청(${orderStatus8})</button>
	    	<button type="button" class="btn btn-primary" style="width: 110px;" name="btnOderStatus" data-odr_status="취소완료">취소완료(${orderStatus9})</button>
	    	<button type="button" class="btn btn-primary" style="width: 110px;" name="btnOderStatus" data-odr_status="교환요청">교환요청(${orderStatus10})</button>
	    	<button type="button" class="btn btn-primary" style="width: 110px;" name="btnOderStatus" data-odr_status="교환완료">교환완료(${orderStatus11})</button>
	    </div>
	</div>
  ...
  <div class="row">
    <div class="col-md-12">
      <button type="button" class="btn btn-link" id="btnCheckedOrderState">선택주문변경</button>
    </div>
   </div>
	<nav aria-label="...">
	  <ul class="pagination">
...
<script>
  $(document).ready(function() {
    ...
    $("button[name='btnOrderDelete']").on("click", function() {
      ...
      // 브라우저 뒤로가기에 의한 파라미터 중복추가부분 방지하기위해 제거작업
    ...
    // 선택주문상태변경
    $("#btnCheckedOrderState").on("click", function() {
