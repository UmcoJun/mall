...
<div class="wrapper">
  ...
  <table class="table table-hover">
      ...
      <button type="button" name="btnSaleYN" data-pdt_num="${productVO.pdt_num }" class="btn btn-link">변경</button>
	      </td>    
	      <td>
	      ...
	      <button type="button" name="btnProductEdit" data-pdt_num="${productVO.pdt_num }" class="btn btn-link">수정</button></td>
	      <td>
          ...
          <button type="button" name="btnProductDelete" data-pdt_num="${productVO.pdt_num }"  class="btn btn-link">삭제</button>
        </td>
	    </tr>
	    </c:forEach>
...
<script>
  $(document).ready(function() {
    ...
    $("#c_pdt_name td a.move").on("click", function(e) {
    	e.preventDefault();
    ...
    // 상품판매 여부
    $("button[name='btnSaleYN']").on("click", function() {
