			...
			<div class="box-body no-padding">
				...
				<tbody><tr>
					...
					<tr>
				      ...
				      <td>￦<span class="pdt_price"><fmt:formatNumber type="currency" pattern="#,###" currencySymbol="₩" value="${orderListVO.pdt_price }" />
				      </span></td>
				      <td>
				      ...
				      <td>택배</td>
				      <td>무료</td>
				      <td>￦<span class="sales_price"><fmt:formatNumber type="currency" pattern="#,###" currencySymbol="₩" value="${orderListVO.sales_price }" />
				      </span>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $("#pay_method").on("change", function() {
        ...
        */
        $("#btnOrder").attr("disabled", false); // 주문하기버튼 
        $("input#kakao_pay").attr("disabled", true); // 카카오페이 버튼

        if($("#pay_method option:selected").val() == "카카오페이") {
          
          $("#btnOrder").attr("disabled", true); 
          $("input#kakao_pay").attr("disabled", false); 
	  ...
	  $("#kakao_pay").on("click", function(e) {
		...
		$.ajax({
			...
			success: function(response) {
				// next_redirect_pc_url : "http://localhost:8888/order/orderApproval?pg_token= 랜덤값 "
