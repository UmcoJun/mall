...
<div class="container">
      <div class="row">
        ...
        <div class="col-md-3.1" style="padding-right: 10px">
          <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
              	<fmt:formatNumber type="currency" pattern="￦#,###" currencySymbol="₩" value="${productVO.pdt_price }" />원
              </p>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $("button[name='btnDirectOrder']").on("click", function() {
        ...
        if($("button[name='btnDirectOrder']") == null){
        	alert("회원가입 후 이용해주세요.")
        }
      });
