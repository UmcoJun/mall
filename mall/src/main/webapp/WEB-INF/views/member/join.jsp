...
<div class="container">
  ...
  <div class="mb-3 text-center">
	  <form id="joinForm" action="join" method="post">
		  ...
		  <div class="form-group row">
		      <label class="form-check-label col-sm-2" for="mem_accept_e">이메일 수신동의</label>
  ...
  $(document).ready(function() {
    ...
    $("#btnAuthcode").on("click", function() {
      ...
      $.ajax({
        url: '/email/send',
        type: 'get',
        dataType: 'text',  // 'xml', 'html', 'json', 'text' 이 부분은 용도에 따라 이 중 하나를 사용한다
        data: { receiverMail: $("#mem_email").val() }, // JavaScript Object구문
        success: function(data) {
          if(data == "success") {
            alert("인증메일이 발송되었습니다. 인증코드를 확인해주세요.");
          }else{
            alert("메일 발송이 실패되었습니다. 괸라자에게 문의해주세요.");
          }
        }
      });
    });
    ...
    $("#btnJoin").on("click", function() {
      ...
      if(isCheckID == false && isMailAuth == false) {
