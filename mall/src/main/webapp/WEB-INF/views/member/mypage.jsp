...
<div class="container">
  <h3>마이페이지</h3>
    <div class="mb-3 text-center">
        ...
        <div class="row">
          <label for="mem_pw" class="col-sm-2 col-form-label">진행중인 주문</label>
          <div class="col-sm-5">
        ...
        <div class="row">
          <label for="mem_pw" class="col-sm-2 col-form-label">적립 포인트</label>
          <div class="col-sm-5">
          	<span>${sessionScope.loginStatus.mem_point }포인트</span>
          </div>
        </div>
    </div>
